...
export default function Form({ formValues, setFormValues, formErrors }: Props) {
  return (
            ...
            <input
              ...
              className={`mt-1 p-1.5 ${
                formErrors.make
                  ...
                  : "focus:ring-gray-500 focus:border-gray-500 border-gray-300"
              } block w-full shadow-sm sm:text-sm rounded-md border`}
            />
          </div>
